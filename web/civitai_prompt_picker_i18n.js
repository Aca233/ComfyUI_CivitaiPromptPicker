const STRINGS = {
    zh: {
        ...
        hoverModelNameLabel: "模型",
        hoverModelIdLabel: "模型 ID",
        hoverModelVersionLabel: "模型版本",
        hoverModelVersionIdLabel: "模型版本 ID",
        hoverImageIdLabel: "图片 ID",
        hoverAuthorLabel: "作者",
        hoverBaseModelLabel: "基础模型",
        hoverResolutionLabel: "分辨率",
        hoverNsfwLabel: "NSFW",
        hoverMetadataLabel: "Metadata",
        hoverCreatedAtLabel: "发布时间",
        hoverPostIdLabel: "帖子 ID",
        hoverImagePageLabel: "图片页",
        hoverYes: "是",
        hoverNo: "否",
        hoverUnknownValue: "未知",
    },
    en: {
        allTime: "All time",
        pastDay: "Past day",
        ...
        hoverModelNameLabel: "Model",
        hoverModelIdLabel: "Model ID",
        hoverModelVersionLabel: "Model version",
        hoverModelVersionIdLabel: "Model version ID",
        hoverImageIdLabel: "Image ID",
        hoverAuthorLabel: "Author",
        hoverBaseModelLabel: "Base model",
        hoverResolutionLabel: "Resolution",
        hoverNsfwLabel: "NSFW",
        hoverMetadataLabel: "Metadata",
        hoverCreatedAtLabel: "Published",
        hoverPostIdLabel: "Post ID",
        hoverImagePageLabel: "Image page",
        hoverYes: "Yes",
        hoverNo: "No",
        hoverUnknownValue: "Unknown",
    },
};
